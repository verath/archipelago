...
func (e *actionErrorImpl) Player() *model.Player { return e.player }
func (e *actionErrorImpl) IsFatal() bool         { return e.fatal }

func newActionError(player *model.Player, text string, fatal bool) ActionError {
...
func newIllegalActionError(player *model.Player, text string) error {
...
func newInvalidActionError(player *model.Player, text string) error {
