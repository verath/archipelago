...
server {
	...
	add_header Content-Security-Policy "default-src 'none'; base-uri 'self'; block-all-mixed-content; child-src 'self'; connect-src 'self' wss://playarchipelago.com; img-src 'self' data:; manifest-src 'self'; script-src 'self' 'unsafe-eval'; style-src 'self'; worker-src 'self';";
